...
import { Search, TrendingUp, Loader2, UserPlus, UserCheck, Briefcase, HandHeart, Music2 } from "lucide-react";
    ...
    <div className="pb-20 pt-4">
      ...
      <div className="mb-3 flex gap-2 px-4">
        ...
        <button onClick={() => navigate("/tiktok")}
          className="flex items-center gap-1.5 rounded-full bg-secondary px-3 py-1.5 text-xs font-semibold text-muted-foreground">
